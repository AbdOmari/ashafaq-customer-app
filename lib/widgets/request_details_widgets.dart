                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            const Image(
                              image: AssetImage("${AppConstants.imagesPath}rial.png"),
                              width: 17,
                              height: 17,
                            ),
                          ],
            ...
            ? [
                ...
                const CircleAvatar(
                  ...
                  backgroundImage: AssetImage(
                    "${AppConstants.imagesPath}profile_photo.jpg",
                  ),
                ),
              ]
            : [
      ...
      children: [
        ...
        ClipRRect(
          ...
          child: Stack(
            ...
            children: [
              Image.asset("${AppConstants.imagesPath}Maps.png"),
              Column(
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: OutlinedButton.icon(
                      onPressed: () {},
                      icon: Image.asset(
                        "${AppConstants.imagesPath}maps_mark.png",
                        width: 24,
                        height: 24,
                      ),
                      label: Text(
